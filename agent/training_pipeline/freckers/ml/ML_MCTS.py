...
class ML_MCTS():
    ...
    def __init__(self, game: FreckersGame, model: XGWrapper, args):
        self.game = game
        self.model = model
        self.args = args
    ...
    def getPredictions(self, canonicalBoard, depth=0):
        ...
        if v is None:
            ...
            p_actions, valids = self.getSmarterRandPolicy(canonicalBoard)
            return p_actions, 0, valids
